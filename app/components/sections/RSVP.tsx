...
export const RSVP = () => {
  ...
  return (
    <SectionContainer id="rsvp" className="bg-neutral-50">
      <ScrollReveal>
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-sm border-2 border-neutral-100">
          <div className="space-y-6">
            {/* Name */}
            <FormField label="Jméno a příjmení" error={errors.name} required htmlFor="name">
              <Input
                id="name"
                type="text"
                value={formData.name}
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, attending: 'ano' })}
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, attending: 'ne' })}
                    className="w-4 h-4 text-pastel-blue focus:ring-pastel-blue"
                  />
                  <span>Ne</span>
                </label>
            ...
            {formData.plusOne && (
              <FormField label="Jméno doprovodu" error={errors.plusOneName} required htmlFor="plusOneName">
                <Input
                  id="plusOneName"
                  type="text"
            ...
            {formData.attending === 'ano' && (
              <FormField label="Preferovaný oběd" error={errors.mealPreference} required htmlFor="mealPreference">
                <Select
                  id="mealPreference"
            ...
            <FormField label="Dietní omezení" error={errors.dietaryRestrictions} htmlFor="dietaryRestrictions">
              <textarea
